...
\begin{subfigure}{.45\textwidth}
  \centering
  \includegraphics[width=95mm,height=60mm,keepaspectratio]{\folder/images/radar_plot}
...
\begin{subfigure}{.45\textwidth}
  \centering
  \includegraphics[width=95mm,height=60mm,keepaspectratio]{\folder/images/bar_plot}
